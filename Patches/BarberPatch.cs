...
namespace ToggleEnemies.Patches
{
    ...
    internal class BarberPatch
    {
        ...
        {
            if (!ToggleEnemiesBase.RemoveBarber.Value) { return; }
            if (!GameNetworkManager.Instance.isHostingGame) { return; }

            var obj = UnityEngine.Object.FindObjectOfType<ClaySurgeonAI>();
            ...
            ToggleEnemiesBase.logger.LogInfo("A barber has been deleted.");
