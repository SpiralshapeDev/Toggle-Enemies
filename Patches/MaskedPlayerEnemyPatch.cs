...
namespace ToggleEnemies.Patches
{
    ...
    internal class MaskedPlayerEnemyPatch
    {
        ...
        {
            if (!ToggleEnemiesBase.RemoveMasked.Value) { return; }
            if (!GameNetworkManager.Instance.isHostingGame) { return; }

            var obj = UnityEngine.Object.FindObjectOfType<MaskedPlayerEnemy>();
            ...
            ToggleEnemiesBase.logger.LogInfo("A masked player has been deleted.");
