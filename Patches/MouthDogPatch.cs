...
namespace ToggleEnemies.Patches
{
    ...
    internal class MouthDogPatch
    {
        ...
        {
            if (!ToggleEnemiesBase.RemoveMouthDog.Value) { return; }
            if (!GameNetworkManager.Instance.isHostingGame) { return; }

            var obj = UnityEngine.Object.FindObjectOfType<MouthDogAI>();
            ...
            ToggleEnemiesBase.logger.LogInfo("An eyeless dog has been deleted.");
